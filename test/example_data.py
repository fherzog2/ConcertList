...
def get_example_concerts():
    ...
    c4 = concert_list.create_concert(datetime.date(2024, 2, 2), "Hamburg, Grosse Freiheit 36", ["Chaosbay", "Flash Forward", "Emil Bulls"])
    c5 = concert_list.create_concert(datetime.date(2024, 2, 2), "Hamburg, Gruenspan", ["Any Given Day"])
